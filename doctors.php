                ...
                <tr >
                    ...
                    <td>
                        ...
                        <form action="" method="post" class="header-search">
                            ...
                            <input type="search" name="search" class="input-text header-searchbar" placeholder="Search Doctor name or Contact" list="doctors">&nbsp;&nbsp;
                            
                            <?php
                                echo '<datalist id="doctors">';
                                $list11 = $database->query("select  docname,doccontact from  doctor;");
...
?>
                ...
                <?php
                    if($_POST){
                        ...
                        $sqlmain= "select * from doctor where doccontact='$keyword' or docname='$keyword' or docname like '$keyword%' or docname like '%$keyword' or docname like '%$keyword%'";
                    }else{
    ...
    if($_GET){
            ...
            <div id="popup1" class="overlay">
                    ...
                    <center>
                        ...
                        <tr>
                            ...
                            <tr>
                                <td class="label-td" colspan="2">
                                    <input type="contact" name="contact" class="input-text" placeholder="Contact Number" required><br>
                                </td>
                            </tr>
                            <tr>
                                <td class="label-td" colspan="2">
        ...
        ';
            ...
            $error_1=$_GET["error"];
                $errorlist= array(
                    '1'=>'<label for="promter" class="form-label" style="color:rgb(255, 62, 62);text-align:center;">Already have an account for this Contact number.</label>',
                    '2'=>'<label for="promter" class="form-label" style="color:rgb(255, 62, 62);text-align:center;">Password Conformation Error! Reconform Password</label>',
                    '3'=>'<label for="promter" class="form-label" style="color:rgb(255, 62, 62);text-align:center;"></label>',
                    '4'=>"",
                    '0'=>'',
                                ...
                                <tr>
                                    ...
                                    <tr>
                                        <td class="label-td" colspan="2">
                                            ...
                                            <input type="hidden" name="oldcontact" value="'.$contact.'" >
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="label-td" colspan="2">
                                        <input type="contact" name="contact" class="input-text" placeholder="Contact Number" value="'.$contact.'" required><br>
                                        </td>
                                    </tr>
                                    <tr>
