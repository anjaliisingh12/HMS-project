...
<body>
    ...
    if (isset($usercontact) && !empty($usercontact)) {
        ...
        if ($userrow && $userrow->num_rows > 0) {
            ...
            echo "No user found with the provided contact information.";
            exit;
        }
    } else {
        echo "User contact information is not set.";
        exit;
    }
    ?>
                                    ...
                                    <table width="80%" class="sub-table scrolldown add-doc-form-container" border="0">
                                        ...
                                        <tr>
                                            <td class="label-td" colspan="2">
                                                ...
                                                <input type="contact" name="contact" class="input-text" placeholder="Email Address" value="' . $contact . '" required><br>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td class="label-td" colspan="2">
                ...
                <div id="popup1" class="overlay">
                    <div class="popup">
                        <center>
                            ...
                            <a class="close" href="settings.php">&times;</a>
                            <div class="content">
                                If You change your contact also Please logout and login again with your new contact number
                            </div>
                            <div style="display: flex;justify-content: center;">
